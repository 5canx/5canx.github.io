---
title: "IDA逆向作业练习（todo_0）"
date: 2024-11-18T13:30:00+08:00
draft: true
description: 
keywords:
license:
...
![image-20241117214610705](https://fastly.jsdelivr.net/gh/hack-scan/Blog-pic/posts/202411172146721.png)

代码分析得知：

strlen_chk方法有a1参数，所以他可能为输入参数，则赋予v2变量可能为字符串长度，v9可能为申请内存后的地址，大小为v2+1。
strcpy_chk可能为复制操作，将a1复制到v9，运行sub_208BC方法后，释放内存。
